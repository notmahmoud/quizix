    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#FAF9F7' }}>
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 style={{ fontSize: '1.375rem', fontWeight: 500, color: '#111827', marginBottom: '0.25rem' }}>Welcome back</h1>
          <p style={{ fontSize: '0.875rem', color: '#4B5563' }}>Enter your credentials to access your account</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          >
            {isLoading ? <Loader2 style={{ width: 18, height: 18 }} className="animate-spin" /> : 'Log in'}
          </button>
        </form>
        ...
        <p className="mt-6 text-center" style={{ fontSize: '0.875rem', color: '#4B5563' }}>
          ...
          <Link to="/signup" style={{ color: '#0D9488', fontWeight: 500 }}>Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
