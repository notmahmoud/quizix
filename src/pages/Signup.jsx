    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-slate-400 mt-2">Join Quizix to start hosting real-time quizzes</p>
        </div>
        ...
        <p className="mt-8 text-center text-sm text-slate-400">
          ...
          <Link to="/login" className="text-primary-start hover:text-primary-end font-semibold transition-colors">
            Log in
          </Link>
        </p>
      </motion.div>
